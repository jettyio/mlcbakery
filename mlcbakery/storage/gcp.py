...
def get_next_file_number(bucket_name: str, prefix: str, 
                       client: storage.Client) -> int:
...
def upload_file_to_gcs(bucket_name: str, data: bytes, 
                      destination_path: str, client: storage.Client) -> str:
...
def generate_download_signed_url(bucket_name: str, file_path: str, 
                               client: storage.Client, expiration: int = 3600) -> str:
