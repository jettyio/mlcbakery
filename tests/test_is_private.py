...
@pytest.mark.asyncio
async def test_dataset_create_with_is_private_false(test_client):
...
@pytest.mark.asyncio
async def test_dataset_create_without_is_private_defaults_to_true(test_client):
...
@pytest.mark.asyncio
async def test_dataset_update_is_private(test_client):
...
@pytest.mark.asyncio
async def test_dataset_get_returns_is_private(test_client):
...
@pytest.mark.asyncio
async def test_trained_model_create_with_is_private(test_client):
...
@pytest.mark.asyncio
async def test_task_create_with_is_private(test_client):
...
@pytest.mark.asyncio
async def test_invalid_is_private_type_rejected(test_client):
...
@pytest.mark.asyncio
async def test_public_task_accessible_without_auth(test_client):
    ...
    get_resp = await test_client.get(f"/api/v1/tasks/{collection_name}/{task_name}")
    assert get_resp.status_code == 200
    data = get_resp.json()
...
@pytest.mark.asyncio
async def test_private_task_requires_auth(test_client):
    ...
    get_resp_auth = await test_client.get(
